...
def joinSet(itemSet, length):
    ...
    # newremovedSet = set()
    # flagAddItem = True
    # composed_set = [i.union(j) for i in itemSet for j in itemSet if len(i.union(j)) == length]
    ...
    # return filteredSet, newremovedSet
...
def runApriori(data_iter, minSupport, minConfidence):
    ...
    oneCSet, removedSet = returnItemsWithMinSupport(itemSet,
                                        transactionList,
                                        minSupport,
                                        freqSet)
    ...
    while(currentLSet != set([])):
        ...
        #currentLSet, removedSet = joinSet(currentLSet, removedSet,  k)
        currentLSet, removedSet = joinSet(currentLSet, k)
